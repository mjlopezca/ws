...
@Entity
@Table(name="FISICA")
public class PersonaFisicaDao implements Serializable {
	...
	public PersonaFisicaDao(Long idPersona, String nombre, String apellidoPaterno, String apellidoMaterno,
